            ...
            <div class="card-header pt-8">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                        ...
                        @can(str_contains($url, 'docs') ? 'action:inquiry_docs_upload' :
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="badge badge-lg badge-primary">
                        <span id="kt_file_manager_items_counter">{{ $docs->count() }} items</span>
                    </div>
                    <!--end::Folder Stats-->
                </div>
                <!--end::Table header-->
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px sorting_disabled" rowspan="1" colspan="1"
                                        style="width: 384.922px;">Name</th>
                                    <th class="min-w-20px sorting_disabled" rowspan="1" colspan="1"
                                        style="width: 83.2344px;">Size</th>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary">{{ $doc->name }}</a>
                                            </div>
                                        </td>
                                        <td>{{ $doc->size / 1000 }} KB</td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                        ...
                                                        @can(str_contains($url, 'docs') ? 'action:inquiry_docs_download'
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route(str_contains($url, 'docs') ? 'inquiries.download.docs' : 'inquiries.download.confidential', [$doc->id]) }}"
                                                                    class="menu-link px-3">Download File</a>
                                                            </div>
                                                        @endcan

                                                        @can(str_contains($url, 'docs') ? 'action:inquiry_docs_delete' :
                                                            'action:inquiry_confidential_delete')
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('inquiries.files.delete', $doc->id) }}"
