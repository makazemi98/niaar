@can('action:inquiry_comment_add_confidential')
    <div class="d-flex flex-column align-items mb-5">
        ...
        <button class="btn btn-light-danger er fs-6 px-8 py-4" data-bs-toggle="modal"
            data-bs-target="#kt_modal_confidential">Confidential</button>
    </div>
    <!--end::Actions-->

    <!--begin::Modal - status update-->
    <div class="modal fade" id="kt_modal_confidential" tabindex="-1" aria-modal="true" role="dialog" style="padding-left: 0px;">
        <!--begin::Modal dialog-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div>
                        <form id="kt_modal_status_update_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                            action="{{ route('inquiries.add.confidential.comment', $inquiry->id) }}" method="POST">
                            @csrf
                            <div class="mb-13 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">Confidential Messages</h1>
                            </div>
