<div class="d-flex flex-column align-items mb-5">
    <button class="btn btn-danger er fs-6 px-8 py-4" data-bs-toggle="modal"
        data-bs-target="#kt_modal_reassign_decline">Decline Re-Assign</button>
</div>

<div class="modal fade" id="kt_modal_reassign_decline" tabindex="-1" aria-modal="true" role="dialog" style="padding-left: 0px;">
                ...
                <div>
                    <form id="kt_modal_approve_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Decline Re-Assign</h1>
                        </div>
