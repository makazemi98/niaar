...
<div class="d-flex flex-column align-items mb-5">
    <button class="btn btn-success er fs-6 px-8 py-4" data-bs-toggle="modal"
        data-bs-target="#kt_modal_approve">Approve</button>
</div>
<!--end::Actions-->


<!--begin::Modal - status update-->
<div class="modal fade" id="kt_modal_approve" tabindex="-1" aria-modal="true" role="dialog" style="padding-left: 0px;">
    <!--begin::Modal dialog-->
                ...
                <div>
                    ...
                    <form id="kt_modal_approve_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid resize-none" rows="5" name="comment" placeholder="Comment"></textarea>
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
                        <div class="text-center">
                            <button type="reset" id="kt_modal_approve_cancel"
                                class="btn btn-danger me-3">Decline</button>
