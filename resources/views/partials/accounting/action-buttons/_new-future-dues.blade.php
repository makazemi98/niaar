...
<div class="d-flex flex-column align-items mb-0">
    <button class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_Form_new_future_dues">Add
        New Future Dues</button>
</div>
<!--end::Actions-->

<div class="modal fade" id="kt_Form_new_future_dues" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_Form_new_future_dues_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    action="{{ route('admin.accounting.store.future.dues') }}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Set New Future Dues</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                <span class="form-check-label fw-semibold text-muted">isPaid</span>
                            </label>
                            <!--end::Label-->
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_Form_new_future_dues_cancel"
                            class="btn btn-light me-3">Cancel</button>
                        <button type="submit" id="kt_Form_new_future_dues_submit" class="btn btn-primary">
...
{{-- <div class="my-5">
    <!--begin:Form-->
    <form id="kt_Form_new_future_dues_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
        <!--begin::Input group-->
        <div class="row g-9 mb-8">
            <!--begin::Col-->
            <div class="col-md-6 fv-row fv-plugins-icon-container">
        ...
        <!--begin::Actions-->
        <div class="text-center">
            <button type="reset" id="kt_Form_new_future_dues_cancel" class="btn btn-light me-3">Cancel</button>
            <button type="submit" id="kt_Form_new_future_dues_submit" class="btn btn-primary">
                <span class="indicator-label">Save</span>
                <span class="indicator-progress">Please wait...
                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
