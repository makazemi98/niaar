...
<div class="d-flex flex-column align-items mb-0">
    <button class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_Form_new_transaction">Add
        New Transaction</button>
</div>


<div class="modal fade" id="kt_Form_new_transaction" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form id="kt_Form_new_transaction_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    action="{{ route('admin.accounting.store.balance.sheet') }}" method="POST">
                    @csrf
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Set New Transaction</h1>
                    </div>
                    <div class="row g-9 mb-8">
                        {{-- <div class="col-md-6 fv-row fv-plugins-icon-container">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    aria-label="Specify a Category for future usage and reference"
                                    data-bs-original-title="Specify a Category for future usage and reference"
                        ...
                        <div class="col-12 col-sm-12 fv-row fv-plugins-icon-container">
                            ...
                            <select name="category" class="form-select form-select-solid smartsearch_keyword"
                                data-control="select2" data-hide-search="true" data-placeholder="Category">
                                @foreach (App\Enums\BalanceSheetCategoryEnum::values() as $cat)
                                    <option value="{{ $cat }}">
                                        {{ str_replace('_', ' ', strval($cat)) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-sm-12 fv-row fv-plugins-icon-container">
                            ...
                            <select name="customer_id" class="form-select form-select-solid smartsearch_keyword"
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-12 col-sm-12 fv-row fv-plugins-icon-container">
                            ...
                            <select name="supplier_id" class="form-select form-select-solid smartsearch_keyword"
                                data-control="select2" data-hide-search="true" data-placeholder="Supplier">
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}">{{ $supplier->company }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">Recieved</span>
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    aria-label="Specify a Recieved for future usage and reference"
                                    data-bs-original-title="Specify a Recieved for future usage and reference"
                                    data-kt-initialized="1">
                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                            ...
                            <input type="number" class="form-control form-control-solid"
                                placeholder="Enter Recieved" name="recieved">
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">Paid</span>
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    aria-label="Specify a Paid for future usage and reference"
                                    data-bs-original-title="Specify a Paid for future usage and reference"
                                    data-kt-initialized="1">
                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                            ...
                            <!--end::Label-->
                            <input type="number" class="form-control form-control-solid" placeholder="Enter Paid"
                                name="paid">
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
                    ...
                    <!--begin::Input group-->
                    <div
                        class="d-flex align-items-center mb-8 form-check form-switch form-check-custom form-check-solid">
                        <!--begin::Label-->
                        <div class="me-5 ">
                            <label class="fs-6 fw-semibold">Is Paid</label>
                    ...
                    <div class="d-flex flex-column mb-8">
                        ...
                        <textarea class="form-control form-control-solid resize-none" rows="2" name="remark"
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_Form_new_transaction_cancel"
                            class="btn btn-light me-3">Cancel</button>
                        <button type="submit" id="kt_Form_new_transaction_submit" class="btn btn-primary">
