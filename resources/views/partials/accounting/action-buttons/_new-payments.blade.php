...
<div class="d-flex flex-column align-items mb-0">
    <button class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_Form_new_payments">Add
        New Payments</button>
</div>
<!--end::Actions-->

<div class="modal fade" id="kt_Form_new_payments" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_Form_new_payments_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    action="{{ route('admin.accounting.store.payment') }}" method="POST">
                    @csrf
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Set New Payments</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <input type="number" class="form-control form-control-solid" placeholder="Enter Debit"
                                name="debit">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <input type="number" class="form-control form-control-solid" placeholder="Enter Credit"
                                name="credit">
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_Form_new_payments_cancel"
                            class="btn btn-light me-3">Cancel</button>
                        <button type="submit" id="kt_Form_new_payments_submit" class="btn btn-primary">
...
{{-- <!--begin:Form-->
<form id="kt_Form_new_payments_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
    <!--begin::Input group-->
    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
        <!--begin::Label-->
        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
            ...
            <span class="ms-1" data-bs-toggle="tooltip"
                ...
                data-bs-original-title="Specify a Client for future usage and reference" data-kt-initialized="1">
                <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    <div class="row g-9 mb-8">
        ...
        <div class="col-md-6 fv-row fv-plugins-icon-container">
            ...
            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                ...
                <span class="ms-1" data-bs-toggle="tooltip"
                    aria-label="Specify a Credit for future usage and reference"
                    data-bs-original-title="Specify a Credit for future usage and reference" data-kt-initialized="1">
                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                        <span class="path1"></span>
                        <span class="path2"></span>
                        <span class="path3"></span>
        ...
        <div class="col-md-6 fv-row fv-plugins-icon-container">
            ...
            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                ...
                <span class="ms-1" data-bs-toggle="tooltip"
                    ...
                    data-bs-original-title="Specify a INQ No. for future usage and reference" data-kt-initialized="1">
                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                        <span class="path1"></span>
                        <span class="path2"></span>
                        <span class="path3"></span>
    ...
    <!--begin::Actions-->
    <div class="text-center">
        <button type="reset" id="kt_Form_new_payments_cancel" class="btn btn-light me-3">Cancel</button>
        <button type="submit" id="kt_Form_new_payments_submit" class="btn btn-primary">
            <span class="indicator-label">Save</span>
            <span class="indicator-progress">Please wait...
                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
